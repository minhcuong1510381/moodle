    ...
    <div class="container" style="height: 700px;">
        <div class="header">
            ...
            <form id="myform">
                ...
                <div class="alert alert-danger" id="alert" role="alert" style="margin: 0 auto; width: 500px; display: none;">
                ...
                <div class="form-group choose-student-compare" style="margin: 0 auto; width: 500px; display: none;" id="compare-student">
